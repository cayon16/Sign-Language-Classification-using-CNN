...
# Đọc hình ảnh
image_path = 'C:/Users/ADMIN/Desktop/python code/sign_language/dataa/test/A/0.jpg'
...
# Tải mô hình đã lưu
my_model = tf.keras.models.load_model('new_model.h5')
...
print('Predicted word: ', chr(predicted_class + 65))
